...
*/
HTMLCollection.prototype.ind_val = function(index,args){
...
*/
HTMLCollection.prototype.attr_map = function(key_attr,map_o,val_attr){
	var doms = Array.prototype.slice.call(this),
		t_key,t_val;
	doms.map(function(v){
		t_key = v.getAttribute(key_attr);
		if(t_key){
			// get val
